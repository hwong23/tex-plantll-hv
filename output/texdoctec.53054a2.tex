...
Versión actual 1.53054a2 - Compilación para entrega:
accion-actualizacionContd (7c10fe8) - Wed, 23 Jul 2025 20:10:40 +0000

\subsection{Control de Cambios}\label{sec:control-de-cambios}

Historia de cambios del documento.

1.df1daf6 - Compilación para entrega: accion-actualizacionContd
(b135ed9) - Wed, 23 Jul 2025 19:38:44 +0000

1.fa3659d - Compilación para entrega: accion-actualizacionContd
(bb7d611) - Wed, 23 Jul 2025 19:14:14 +0000

1.513ea5a - Compilación para entrega: accion-actualizacionContd
(a656b3c) - Wed, 23 Jul 2025 15:15:23 +0000

1.3bf10ea - Compilación para entrega: accion-actualizacionContd
(88488c1) - Wed, 23 Jul 2025 15:13:02 +0000
...
\subsection{03. Entregables de la
Vision}\label{sec:entregables-de-la-vision}
...
\bottomrule\noalign{}
\endlastfoot
Matriz de Sistemas de Información & Business Object & Las matrices del
dominio de aplicaciones de software y sistemas de información (SI) de SG
son herramientas para el relacionamiento con otros dominios del
ejercicio de arquitectura empresarial de SG. Con esto conseguimos
soportar la toma decisiones de lo que debe ser compartido de los SI
dentro de la Secretaría, y entre sus aplicaciones de software. Las
matrices de este ejercicio sirven además para comunicar el grado de
...
compatibles. \textbar{} \textbar{} Matriz de Sistemas de Información vs
Procesos de Negocio \textbar{} Business Object \textbar{} Las matrices
del dominio de aplicaciones de software y sistemas de información (SI)
de SG son herramientas para el relacionamiento con otros dominios del
ejercicio de arquitectura empresarial de SG. Con esto conseguimos
soportar la toma decisiones de lo que debe ser compartido de los SI
dentro de la Secretaría, y entre sus aplicaciones de software. Las
matrices de este ejercicio sirven además para comunicar el grado de
...
arquitectura empresarial de SG, y contribuyen a que las interacciones
relevantes entre servicios, canales, y procesos estén definidas y sean
compatibles. \textbar{} \textbar{} Catálogo de Sistemas de Información
\textbar{} Business Object \textbar{} En el contexto de TOGAF, El
Catálogo de sistemas de información es un inventario detallado y
...
\item
  ...
  información. \textbar{} \textbar{} Identificar Necesidades TI en SG
  \textbar{} Business Object \textbar{} La construcción de lista de
  necesidades, preocupaciones y oportunidades implican a las sesiones de
  levantamiento, entrevistas, y cuestionarios compartidos en el mes de
  julio, junto con la recopilación estructurada de las fuentes de
  información sobre cada sistema.
\end{itemize}
...
\item
  ...
  actuales asociadas a esta capacidad. \textbar{} \textbar{} Identificar
  Preocupaciones \textbar{} Business Object \textbar{} Con base en el
  estudio de las sesiones de levantamiento, entrevistas, y cuestionarios
  compartidos en el mes de julio, junto con la recopilación estructurada
  de las fuentes de información sobre cada sistema, identificamos las
  siguientes preocupaciones (y debilidades) de SG relacionadas con el
  dominio de sistemas de información, dentro del alcance de este
  ejercicio.
\end{itemize}
...
\item
  ...
  {[}2-12{]}. \textbar{} \textbar{} Identificar Oportunidades \textbar{}
  Business Object \textbar{} La construcción de lista de oportunidades
  mencionadas implica el estudio de las sesiones de levantamiento,
  entrevistas, y cuestionarios compartidos en el mes de julio, junto con
  la recopilación estructurada de las fuentes de información al respecto
  de cada sistema de SG.
\end{enumerate}
...
\{\#tbl:tblelement-03.EntregablesdelaVision-id\}\sidenote{This is a sidenote. This template features a large margin specifically so you can put notes, figures, tables and other things into it as additional material to the main content in the text block.}
