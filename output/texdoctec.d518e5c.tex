...
\tightlist
\item
  \hyperref[visiuxf3n]{Visión}

  \begin{itemize}
  \tightlist
  \item
    \hyperref[necesidades-si-de-sg]{Necesidades SI de SG}
  \item
    \hyperref[preocupaciones-si-de-sg]{Preocupaciones SI de SG}
  \item
    \hyperref[contexto-de-arquitectura-de-sistemas-de-informaciuxf3n-sg]{Contexto
    de Arquitectura de Sistemas de Información SG}
  \item
    \hyperref[oportunidades-si-de-sg]{Oportunidades SI de SG}
  \item
    \hyperref[vistas-y-artefactos-del-dominio]{Vistas y Artefactos del
    Dominio}

    \begin{itemize}
    \tightlist
    \item
      \hyperref[matriz-de-sistemas-de-informaciuxf3n-vs-procesos-de-negocio]{Matriz
      de Sistemas de Información vs Procesos de Negocio}
    \item
      \hyperref[catuxe1logo-de-sistemas-de-informaciuxf3n]{Catálogo de
...
\section{Visión}\label{sec:visiuxf3n}
...
\bottomrule\noalign{}
\endlastfoot
1. Introducción y Contexto Estratégico & Business Object & * La
Secretaría General de la Alcaldía Mayor de Bogotá D.C. busca optimizar
su gestión institucional y cumplir sus objetivos estratégicos en un
entorno dinámico. \\
\end{longtable}
...
\item
  ...
  transparente. \textbar{} \textbar{} 2. Diagnóstico Actual: Debilidades
  Tecnológicas Clave de la Secretaría General \textbar{} Business Object
  \textbar{} Basado en el análisis de las matrices DOFA (Matriz de
  Evaluación de Factores Internos - MEFI y Matriz de Evaluación de
  Factores Externos - MEFE) {[}5, 6{]}, se han identificado las
  siguientes debilidades tecnológicas:
\item
...
\item
  ...
  \item
    ...
    implementar y mantener sistemas avanzados {[}15{]}.
  \end{itemize}
\item
...
\item
  ...
  \item
    ...
    que genera retrasos en la operación {[}13{]}. \textbar{} \textbar{}
    3. La Arquitectura Empresarial (AE) como Solución Estratégica
    \textbar{} Business Object \textbar{} La implementación de un
    ejercicio de Arquitectura Empresarial es clave para abordar estas
    debilidades {[}4{]}.
  \end{itemize}
\item
...
\{\#tbl:tblelement-06.2n4.Aplicaciones.SituacionActualSG-id\}
...
\item
  ...
  actuales asociadas a esta capacidad. undefined\#\# Preocupaciones SI
  de SG
\end{itemize}
...
\item
  ...
  de Bogotá undefined\#\# Oportunidades SI de SG
\end{itemize}
...
A continuación, se presentan las vistas y artefactos del dominio de
...
compatibles. undefined\#\#\# Catálogo de Sistemas de Información
