...
\subsubsection{Plataforma de Trámites en
Línea}\label{sec:plataforma-de-truxe1mites-en-luxednea}
...
\subsubsection{Portal de datos para la
transparencia}\label{sec:portal-de-datos-para-la-transparencia}
...
Componente de aplicación para facilitar la interacción y el feedback de
los ciudadanos.

\subsubsection{Sistema de Gestión
Documental}\label{sec:sistema-de-gestiuxf3n-documental}

Componente de aplicación para la gestión electrónica de
