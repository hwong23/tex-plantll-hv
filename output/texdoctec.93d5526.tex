...
Versión actual 1.93d5526 - Compilación para entrega:
accion-actualizacionContd (a42cb37) - Wed, 23 Jul 2025 20:27:32 +0000

\subsection{Control de Cambios}\label{sec:control-de-cambios}

Historia de cambios del documento.

1.53054a2 - Compilación para entrega: accion-actualizacionContd
(7c10fe8) - Wed, 23 Jul 2025 20:10:40 +0000
...
\tightlist
\item
  \textbf{Matriz de Sistemas de Información}. Las matrices del dominio
  de aplicaciones de software y sistemas de información (SI) de SG son
  herramientas para el relacionamiento con otros dominios del ejercicio
  de arquitectura empresarial de SG. Con esto conseguimos soportar la
  toma decisiones de lo que debe ser compartido de los SI dentro de la
...
\tightlist
\item
  \textbf{Matriz de Sistemas de Información vs Procesos de Negocio }.
  ...
  otros dominios del ejercicio de arquitectura empresarial de SG. Con
  esto conseguimos soportar la toma decisiones de lo que debe ser
  compartido de los SI dentro de la Secretaría, y entre sus aplicaciones
  de software. Las matrices de este ejercicio sirven además para
  comunicar el grado de relacionamiento de los elementos.
\end{itemize}
...
\item
  ...
  documentado que actúa como ficha técnica de los sistemas de
  información o aplicaciones de software de SG.
\end{itemize}
...
\item
  ...
  información.
\item
  \textbf{Identificar Necesidades TI en SG}. La construcción de lista de
...
\item
  \textbf{Identificar Preocupaciones}. Con base en el estudio de las
  sesiones de levantamiento, entrevistas, y cuestionarios compartidos en
  el mes de julio, junto con la recopilación estructurada de las fuentes
  de información sobre cada sistema, identificamos las siguientes
...
\tightlist
\item
  \textbf{Identificar Oportunidades}. La construcción de lista de
