...
ejercicio de arquitectura empresarial de SG.

En particular, y dentro del alcance de la visión de este proyecto, la
arquitectura de sistemas de información de SG se plantea:
...
\item
  ...
  \item
    Subsecreataría de Comunicaciones (\ldots)
  \end{itemize}
\item
  Consejería TI (Celi)
\end{itemize}
...
información (SI) de la Secretaria General Alcaldía Mayor de Bogotá (SG)
son herramientas para el relacionamiento con otros dominios del
ejercicio de arquitectura empresarial de la SG. Mediante las matrices
...
que apoyan la misionalidad de la SG.
