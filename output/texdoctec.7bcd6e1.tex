...
\tightlist
\item
  Catálogo de sistemas de información. Caracterización de los sistemas
  de información y su integración con los catálogos, matrices o
  diagramas de sistemas de información
\item
  Definición de la Arquitectura de Referencia de la Entidad (situación
  actual del dominio aplicaciones, referencia cero), que contenga el
  modelo de alto nivel, en el cual se visualicen sistemas de información
  existentes y su interrelación.
\item
  Arquitecturas de Solución de los proyectos de sistemas de información
  de la Entidad. Deben contener como mínimo:
  ...
  \end{itemize}
\item
  Plan de Implementación y Migración que establezca la secuencia de
  ejecución de la hoja de ruta de transformación de este domiinio; esto
  incluye mencionar los riesgos y los beneficios de las iniciativas que
  tratarán las brechas de cambio.
\end{enumerate}
