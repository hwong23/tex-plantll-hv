...
\subsection{06.1nb. Aplicacion. Aplc y
Procesos}\label{sec:nb.-aplicacion.-aplc-y-procesos}
...
\begin{figure}
\centering
\includegraphics{images/06.1nb.Aplicacion.AplcyProcesos.png}
\caption{06.1nb. Aplicacion. Aplc y Procesos. \emph{Fuente: Propuesta
...
\caption{\label{tbl:tblelement-06.1nb.Aplicacion.AplcyProcesos-id}Elementos
...
unificada para acceder a diversos servicios y trámites ciudadanos. \\
...
y planeación. \\
Plataforma de Trámites en Línea & Application Component & Componente de
aplicación que permite la realización de trámites digitales. \\
Portal Bogotá Capital Digital & Application Component & Portal
Integrador de trámites y servicios ofrecidos a la ciudadanía. \\
Portal de datos para la transparencia & Application Component &
...
de aplicación para facilitar la interacción y el feedback de los
ciudadanos. \\
...
colaboración}\label{sec:ofimuxe1tica-y-colaboraciuxf3n}\sidenote{This is a sidenote. This template features a large margin specifically so you can put notes, figures, tables and other things into it as additional material to the main content in the text block.}
